...
public class ClientGameScreen extends View {
	...
	public ClientGameScreen(Client client) {
		...
		try {
			background = ImageIO.read(getClass().getResource("items/images/board_blue.jpeg"));
		} catch (Exception e) {
			e.printStackTrace();
		}

		Location l = game.getClientLocation();
		player = new Player(l.getX(), l.getY(), "images/robot2.png");
		l = game.getServerLocation();
		serverPlayer = new Player(l.getX(), l.getY(), "images/robot1.png");
